...
const SLIDES_INFO = [
    {
        ...
        "content": "El pan es un alimento básico y símbolo cultural en España, presente en todas las comidas y tradiciones. Su relevancia histórica y social lo convierte en parte esencial de la identidad nacional.",
        "URL": "https://wallpapers.com/images/featured/pan-rtzqhi1ok4k1bxlo.jpg"
    },
    {
        "title": "Historia y gremios",
        "content": "En la Edad Media, los panaderos se organizaban en gremios y la producción era regulada por concejos municipales, mostrando el control y valor social del pan en la economía española.",
    ...
    },
    {
        ...
        "content": "Cada región de España tiene su especialidad de pan, como el 'pa de pagès' en Cataluña y el pan de centeno en Galicia, reflejando la diversidad cultural y gastronómica del país.",
    ...
    },
    {
        ...
        "content": "El pan simboliza generosidad y hospitalidad en la sociedad española, siendo un alimento que une a la comunidad y representa valores compartidos.",
    ...
    },
    {
        ...
        "content": "El aumento de costos y competencia ha afectado la calidad del pan en algunas áreas, pero sigue siendo fundamental en la cultura y tradición españolas.",
        "URL": "https://i.pinimg.com/736x/cc/1e/72/cc1e72b1045ee2aca015f6f4dfa53b88.jpg"
    },
    {
        "title": "El pan en la dieta diaria",
        "content": "El pan se consume diariamente en la mayoría de los hogares españoles, manteniéndose como parte esencial de la alimentación y costumbres familiares.",
